            ...
            <nav class="navbar header-navbar pcoded-header" >
               <div class="navbar-wrapper" >
                   <div class="navbar-logo">
                       ...
                       <a href="index.html">
                           <img class="img-fluid" src="{{ asset('assets/dashboard/assets/images/fasoDo.png') }}"width=50px height="10px" alt="Theme-Logo" />
                       </a>
                                   ...
                                   <li>
                                       <div class="media">
                                           ...
                                           <div class="media-body">
                                               ...
                                               <p class="notification-msg">votre demande</p>
                                               <span class="notification-time">Il ya, 30 minutes </span>
                                           </div>
                                       </div>
                                   </li>
                                   <li>
                                       <div class="media">                              
                                           ...
                                           <div class="media-body">
                                               <h5 class="notification-user">Sanata Fané</h5>
                                               <p class="notification-msg">Votre demande a eté Validéé.</p>
                                               <span class="notification-time">il y'a 1 mois</span>
                                           </div>
                                       </div>
                                   </li>
                                   <li>
                                       <div class="media">
                                           ...
                                           <div class="media-body">
                                               <h5 class="notification-user">Faty Konta</h5>
                                               <p class="notification-msg">Report de Rendez Vous au 31/10/2022.</p>
                                               <span class="notification-time">Il y'a 3 mois</span>
                                           </div>
                                       </div>
                                   </li>
                               </ul>
                        ...
                        <div class="pcoded-inner-navbar main-menu" >
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)">
                                        <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Operations</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                {{-- <li>
                                    <a href="form-elements-component.html">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Mes Operations</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li> --}}
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="auth-normal-sign-in.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Admin</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="auth-sign-up.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Receptionniste</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
