    ...
    <div class="page-body">
        <div class="row">
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-blue order-card" onclick="location.href='{{ route('carteciaffichage') }}';" style="cursor: pointer">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">Cartes d'identités</h6>
                                                        <h2 class="text-right"><i class="ti-shopping-cart f-left"></i><span>{{$ayira->count()}}</span></h2>
                                                        <p class="m-b-0">Cette semaine<span class="f-right">!=done</span></p> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-green order-card" onclick="location.href='{{ url('demandecrrecp') }}';" style="cursor: pointer">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">Certificats Residences</h6> 
                                                        <h2 class="text-right"><i class="ti-tag f-left"></i><span>{{  $nanayé->count() }}</span></h2>    
                                                        <p class="m-b-0">Cette semaine<span class="f-right">!=done</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-yellow order-card" onclick="location.href='{{ route('voirlisterdv') }}';" style="cursor: pointer">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20"> Retraits</h6>
                                                        <h2 class="text-right"><i class="ti-reload f-left"></i><span>{{ $retrait->count() }}</span></h2>
                                                        <p class="m-b-0">Ce mois<span class="f-right">!=done</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-pink order-card" onclick="location.href='{{ route('voirtouslescitoyens') }}';" style="cursor: pointer">
                                                    <div class="card-block">
                                                        <h6 class="m-b-20">Utilisateurs</h6>
                                                        <h2 class="text-right"><i class="ti-wallet f-left"></i><span>{{ $malidew->count() }}</span></h2>
                                                        <p class="m-b-0">Ce mois<span class="f-right">!=done</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Statistics des demandes et retraits</h5>
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="row justify-content-center m-t-15">
                                                            <div class="col-auto b-r-default m-t-5 m-b-5">
                                                                <h4>83%</h4>
                                                                <p class="text-success m-b-0"><i class="ti-hand-point-up m-r-5"></i>Validées</p>
                                                            </div>
                                                            ...
                                                            <div class="tab-pane" id="messages3" role="tabpanel">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table">
                                                                        ...
                                                                        <tr>
                                                                            <td><img src="{{ asset('assets/dashboard/assets/images/product/prod1.jpg') }}" alt="prod img" class="img-fluid"></td>
                                                                            <td>PNG002413</td>
                                                                            <td>Jane Elliott</td>
                                                                            <td>06-01-2017</td>
                                                        ...
                                                        <ul class="feed-blog">
                                                            <li class="active-feed">
                                                                <div class="feed-user-img">
                                                                    <img src="{{ asset('assets/dashboard/assets/images/avatar-3.jpg') }}" class="img-radius " alt="User-Profile-Image">
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-auto text-center">
                                                                        <img src="{{ asset('assets/dashboard/assets/images/blog/blog-r-1.jpg') }}" alt="img" class="img-fluid img-100">
                                                                        <h6 class="m-t-15 m-b-0">Old Scooter</h6>
                                                                        <p class="text-muted m-b-0"><small>PNG-100KB</small></p>
                                                                    </div>
                                                                    <div class="col-auto text-center">
                                                                        <img src="{{ asset('assets/dashboard/assets/images/blog/blog-r-2.jpg') }}" alt="img" class="img-fluid img-100">
                                                                        <h6 class="m-t-15 m-b-0">Wall Art</h6>
                                                                        <p class="text-muted m-b-0"><small>PNG-150KB</small></p>
                                                                    </div>
                                                                    <div class="col-auto text-center">
                                                                        <img src="{{ asset('assets/dashboard/assets/images/blog/blog-r-3.jpg') }}" alt="img" class="img-fluid img-100">
                                                            ...
                                                            <li class="diactive-feed">
                                                                <div class="feed-user-img">
                                                                    <img src="{{ asset('assets/dashboard/assets/images/avatar-2.jpg') }}" class="img-radius " alt="User-Profile-Image">
                                                                </div>
